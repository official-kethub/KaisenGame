...
class ksg{;
  ...
  public static void zibungakougeki(){
    ...
    //int koa = sc.nextInt();
    if(hensu.k==1 && hensu.l==1){
      at = "A2";
    }
    if(hensu.k==1 && hensu.l==2){
      at = "B1";
    }
    if(hensu.k==1 && hensu.l==3){
      at = "B2";
    }
    if(hensu.k==2 && hensu.l==1){
      at = "A4";
    }
    if(hensu.k==2 && hensu.l==2){
      at = "B4";
    }
    if(hensu.k==2 && hensu.l==3){
      at = "B5";
    }
    if(hensu.k==3 && hensu.l==1){
      at = "D1";
    }
    if(hensu.k==3 && hensu.l==2){
      at = "D2";
    }
    if(hensu.k==3 && hensu.l==3){
      at = "E2";
    }
    if(hensu.k==4 && hensu.l==1){
      at = "D4";
    }
    if(hensu.k==4 && hensu.l==2){
      at = "D5";
    }
    if(hensu.k==4 && hensu.l==3){
      at = "E4";
    }
